...
* How to run the test suite
  ...
  *NOTE:* For this you will need the Kalibro Processor service up and running as explained below.
...
* Services (job queues, cache servers, search engines, etc.)
  ...
  * Kalibro Processor
    ...
    * In order to run it as expected, run on two different terminal instances: ```RAILS_ENV=local rails s -p 8082```.
