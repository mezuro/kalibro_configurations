...
ActiveRecord::Schema.define(version: 20160530174633) do
  ...
  add_index "kalibro_configurations", ["language"], name: "index_kalibro_configurations_on_language", using: :btree
